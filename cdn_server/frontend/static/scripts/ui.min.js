...
class MaterialDark extends Theme{constructor(){super();this._primary="#6200EE";this._primaryVariant="#3700B3";this._secondary="#03DAC6";this._secondaryVariant="#018786";this._background="#000";this._onBackground="#fff";this._surface="#000";this._onSurface="#fff";this._warn="#00FFFF";this._onWarn="#FFFFFF";this._error="#FF0000";this._onError="#FFFFFF";this.name="material-dark";}}
class Element extends HTMLElement{constructor(){super();this._theme=null;}
...
connectedCallback(){this._potrait=this.getAttribute("potrait");this._landscape=this.getAttribute("landscape");this.style.display="grid";this.style.gridTemplateAreas='\''+this._landscape.split(';').join('\' \'')+'\'';this.style.gridGap="10px";this.style.gridAutoColumns="1fr";}}
class GridComponent extends Element{constructor(){super();}
connectedCallback(){this.style.gridArea=this.getAttribute('name');this.style.boxShadow="0px 0px 10px rgba(0, 0, 0, 0.2)";this.style.maxWidth="100%";}}
...
attributeChangedCallback(name,oldValue,newValue){console.log(this.toString()+" AttributeChangedCallback");switch(name){case"menu":this._resetGridTemplateAreas();break;case"colors":this._resetColors();break;case"dark-theme":this.toggleDarkTheme();break;}}
...
connectedCallback(){this.style.gridArea='main';this.style.padding="5pt";this.theme=this.parentNode.theme;this.style.background=this.theme.background;}
disconnectedCallback(){}
static get observedAttributes(){}
attributeChangedCallback(name,before,after){}
...
return layoutType;}
connectedCallback(){this.style.width="100%";this.style.height="100%";this.style.display="grid";this.style.gridGap="0pt";this.style.padding="0pt";this.style.visibility="visible";this.style.gridAutoColumns="1fr";this.appendChild(document.createElement('tabs-keeper'));this._resetGridTemplateAreas();}
disconnectedCallback(){console.log(this+" DisconnectedCallback");}
