...
constructor(username,wsConf,rtcConf){this.username=username;this.wsConf=wsConf;this.rtcConf=rtcConf;if(this.wsConn==null){if('proto'in wsConf)
this.wsConn=new WebSocket(wsConf.url,wsConf.proto);else
this.wsConn=new WebSocket(wsConf.url);this.wsConn.onopen=function(evt){RtcEntityConnection.onWsOpen(evt);}
