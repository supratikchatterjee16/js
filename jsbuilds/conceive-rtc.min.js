...
constructor(username,wsConf,rtcConf){this.username=username;this.wsConf=wsConf;this.rtcConf=rtcConf;if(this.wsConn==null){this.wsConn=new WebSocket(wsConf.url,"json");this.wsConn.onopen=function(evt){RtcEntityConnection.onWsOpen(evt);}
...
static loopback(data){var dataJson=JSON.stringify(data);RtcEntityConnection.wsConn.send(dataJson);}
