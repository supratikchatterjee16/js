...
class TabButton extends ResponsiveElement{constructor(){super();this.registeredObject=null;this.state=null;this.active=false;this._titlePane=document.createElement('span');if(this.innerHTML=='')
this._titlePane.innerHTML="untitled";else
this._titlePane.innerHTML=this.innerHTML;this.activateEvent=new CustomEvent("activate",{bubbles:false});this.deactivateEvent=new CustomEvent("deactivate",{bubbles:false});}
