...
class TabButton extends ResponsiveElement{constructor(){super();this.registeredObject=null;this.state=null;this.active=false;this._titlePane=document.createElement('span');console.log(this.innerHTML);if(this.innerHTML=='')
