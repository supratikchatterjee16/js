...
this.addEventListener("click",(event)=>{this.parentNode.select(this);});if(this.hasAttribute('onactivate')){this.addEventListener('activate',Function(this.getAttribute('onactivate')));}
if(this.hasAttribute('ondeactivate')){this.addEventListener('deactivate',Function(this.getAttribute('ondeactivate')));}}
